...
import 'package:weather/widgets/geo_distance.dart';
                  ...
                  children: [
                    Row(
                      children: [
                        TextButton(
                          onPressed: () async {
                            var weatherData =
                                await weather.getLocationWeatherData(context);
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        if (typedName != null) {
                          var weatherData =
                              await weather.getCityWeatherData(typedName);
                          updateUI(weatherData);
                        }
                      },
                      child: const Icon(
